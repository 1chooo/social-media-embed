...
Pass `appearance` to control whether the card chrome uses a light or dark palette:
...
See [Custom Rendering → Dark mode and appearance](./custom-rendering#dark-mode-and-appearance) for a full example wiring this to `next-themes`.
